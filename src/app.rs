    ...
    html! {
        <>
            ...
            <div style="display: flex; justify-content: center; align-items: center; width: 80%; margin: 0 auto;">
                ...
                <button onclick={on_click_number2} style="font-size: 2em; width: 40%; margin: 0 10px; background-color: violet;">{ numbers.number2 }</button>
            </div>
            {
                if *show_numbers_as_images {
                    html! {
                        <div style="display: flex; justify-content: center; align-items: center; width: 80%; margin: 0 auto;">
                            ...
                            { number_as_svg(numbers.number2, "violet".to_string() ) }
                        </div>
                    }
                }
                else {
